"""Spain Electricity Periods sensor platform."""
...
async def async_setup_entry(
    ...
    config_entry: ConfigEntry,  # noqa: ARG001 Unused function argument: `config_entry`
    async_add_entities: AddEntitiesCallback,
) -> None:
    """Set up the Spain Electricity Periods sensor."""
    async_add_entities([SpainElectricityPeriod()], update_before_add=True)
    LOGGER.info("Spain Electricity Periods sensor added.")


class SpainElectricityPeriod(SensorEntity):
    """Spain Electricity Periods sensor."""

    _attr_translation_key = "spain_electricity_period"
    _attr_should_poll = False
    _attr_has_entity_name = True

    def __init__(self) -> None:
        """Initialize the sensor."""
        self._attr_unique_id = "spain_electricity_period"
    ...
    def _is_weekend(self, dt: datetime) -> bool:
        ...
        return dt.weekday() >= 5  # noqa: PLR2004

    def _is_holiday(self, dt: datetime) -> bool:
        """Check if the given date is a Spain holiday."""
        return (dt.month, dt.day) in SPAIN_HOLIDAYS
    ...
    def _get_period_for_time(self, dt: datetime) -> str:  # noqa: PLR0911
